...
<body>
    ...
    <table width="600">
       ...
       <tr>
         <td width="100">등록일</td>
         <td width="500"><input value="${vo.regDt }" type="text" name="regDt" id="regDt" maxlength="500" size="50" readonly="readonly"></td>
       </tr>
       <tr>
         <td width="100">수정자</td>
       ...
       <tr>
         <td width="100">수정일</td>
         <td width="500"><input value="${vo.modDt }" type="text" name="modDt" id="modDt" maxlength="500" size="50" readonly="readonly"></td>
       </tr>
       <tr>
         <td width="100">조회수</td>
         <td width="500"><input value="${vo.readCnt }" type="text" name="readCnt" id="readCnt" maxlength="500" size="50" readonly="readonly"></td>
       </tr>
       <tr>
         <td colspan="2">내용</td>
       </tr>
